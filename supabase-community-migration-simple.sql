-- Simplified Supabase Migration Script for Community Features
-- Run this in your Supabase SQL Editor to create the necessary tables

-- First, let's check what tables exist and create the community tables without foreign keys initially

-- 1. Friendships Table (simplified version without foreign keys initially)
...
-- 2. Community Groups Table (simplified version)
...
-- 3. Group Memberships Table (simplified version)
...
-- 4. Community Posts Table (simplified version)
...
-- 5. User Notifications Table (simplified version)
...
-- 6. Community Likes Table (simplified version)
