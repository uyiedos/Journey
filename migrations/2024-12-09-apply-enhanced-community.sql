-- Apply Enhanced Community Changes
-- This script applies all the recent community enhancements including points pools and challenges

-- First, create the enhanced community tables
...
-- Enhanced community groups table with points pool
...
-- Enhanced group memberships table with points tracking
...
INSERT INTO public.community_groups (id, name, description, is_private, created_by, member_count, points_pool, goal_points)
VALUES 
  ('sample-group-1', 'Daily Devotionals', 'A group for sharing daily Bible readings and reflections', false, '00000000-0000-0000-0000-000000000000', 45, 1250, 2000),
  ('sample-group-2', 'Prayer Warriors', 'Join us in prayer and support one another through faith', false, '00000000-0000-0000-0000-000000000000', 32, 890, 1000)
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.group_memberships (group_id, user_id, role, points_contributed)
VALUES 
  ('sample-group-1', '00000000-0000-0000-0000-000000000000', 'admin', 50),
  ('sample-group-2', '00000000-0000-0000-0000-000000000000', 'member', 25)
ON CONFLICT (group_id, user_id) DO NOTHING;

-- Output success message
DO $$
BEGIN
  RAISE NOTICE 'Enhanced community tables and features have been successfully created!';
  RAISE NOTICE 'Features include: Friendships, Enhanced Posts, Groups with Points Pools, Challenges, and Notifications';
END $$;
