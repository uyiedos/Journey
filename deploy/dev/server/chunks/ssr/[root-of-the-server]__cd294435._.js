...
const supabaseAdmin = serviceRoleKey ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$esm$2f$wrapper$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createClient"])(supabaseUrl, serviceRoleKey, {
    auth: {
...
;
const supabaseClient = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"];
class SupabaseService {
    channels = new Map();
    // Helper method to get supabase client
    getClient() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"];
    }
    // Authentication
    ...
    async updateUserProfile(userId, updates) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').update(updates).eq('id', userId).select().single();
            if (error) {
    ...
    async createUserProfile(user, additionalData) {
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').insert(profileData).select().single();
            if (error) {
                console.error('Error creating user profile:', error);
                // If username column doesn't exist, try without it
                if (error.message.includes('column') && error.message.includes('username')) {
                    const { data: dataWithoutUsername, error: errorWithoutUsername } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').insert({
                        id: profileData.id,
    ...
    async getUserStats(userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').select('*').eq('user_id', userId).single();
        if (error) {
    ...
    async updateUserStats(userId, updates) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').update(updates).eq('user_id', userId).select().single();
        if (error) {
    ...
    async createUserStats(userId) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').insert(statsData).select().single();
        if (error) {
    ...
    async getUserAchievements(userId) {
        try {
            ...
            const { achievements } = await __turbopack_context__.A("[project]/src/data/achievements.ts [app-ssr] (ecmascript, async loader)");
    ...
    async getLeaderboard(limit = 50) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leaderboard_view').select('*').order('rank_position', {
                ascending: true
            }).limit(limit);
    ...
    async getLeaderboardFallback(limit = 50) {
        try {
            ...
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*');
            try {
    ...
    async getWeeklyLeaderboard(limit = 50) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leaderboard').select('*').order('weekly_points', {
                ascending: false
            }).limit(limit);
    ...
    async getWeeklyLeaderboardFallback(limit = 50) {
        try {
            ...
            // First try with status filter, then fallback without it
            let query = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').gte('updated_at', sevenDaysAgo.toISOString());
            try {
                query = query.eq('status', 'active');
            } catch (statusError) {
    ...
    async getStreakLeaderboard(limit = 50) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leaderboard').select('*').order('streak', {
                ascending: false
            }).limit(limit);
    ...
    async getUserRank(userId) {
        try {
            ...
            const { data: rankData, error: rankError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('leaderboard').select('rank_position').eq('user_id', userId).single();
            if (!rankError && rankData) {
                return rankData.rank_position;
            }
            // Fallback to calculating rank from users table
            const { data: userData, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('points').eq('id', userId).single();
            if (userError) throw userError;
            const { count, error: rankError2 } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*', {
                count: 'exact',
                head: true
    ...
    subscribeToLeaderboard(callback) {
        ...
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].channel(channelName).on('postgres_changes', {
            event: '*',
            schema: 'public',
            table: 'leaderboard'
        }, async ()=>{
...
"[project]/src/services/referralService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ReferralService {
    static async getReferralInfo(userId) {
        try {
            ...
            const { data: user, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('username, referral_code, email').eq('id', userId).single();
            ...
            if (userError) {
                ...
                const { data: authUser } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
            ...
            const { data: referrals, error: referralError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').select('status, points_awarded').eq('referrer_id', userId);
    ...
    static async processReferral(referralCode, newUserId) {
        try {
            const { data: referrer, error: referrerError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('referral_code', referralCode).single();
            if (referrerError || !referrer) return false;
            const { data: existingReferral } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').select('id').eq('referred_id', newUserId).single();
            ...
            const { error: referralError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').insert({
    ...
    static async completeReferral(referralId) {
        try {
            const { data: referral, error: fetchError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').select('*').eq('id', referralId).single();
            if (fetchError || !referral) throw fetchError;
            const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').update({
                status: 'completed',
                points_awarded: 100,
                completed_at: new Date().toISOString()
            }).eq('id', referralId);
            if (updateError) throw updateError;
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(referral.referrer_id, 100);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('points_transactions').insert({
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_stats').update({
                referrals_completed: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('increment', {
                    amount: 1
                }),
                total_points_earned: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('increment', {
                    amount: 100
                })
            }).eq('user_id', referral.referrer_id);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(referral.referred_id, 50);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('points_transactions').insert({
    ...
    static async validateReferralCode(referralCode) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('referral_code', referralCode).single();
            return !error && !!data;
        } catch (error) {
            return false;
        }
    ...
    static async getReferralHistory(userId) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').select(`
          *,
    ...
    static async checkPendingReferrals(userId) {
        try {
            const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserProfile(userId);
            if (!userProfile) return;
            const isActive = userProfile.points > 0 || userProfile.streak > 0;
            if (isActive) {
                const { data: pendingReferrals } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('referrals').select('id').eq('referred_id', userId).eq('status', 'pending');
...
"[project]/src/contexts/SupabaseAuthContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/supabase.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$referralService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/referralService.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
    ...
    const signUp = async (email, password, fullName, referralCode)=>{
        try {
            ...
            if (referralCode && data.user) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$referralService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["referralService"].processReferral(referralCode, data.user.id);
            }
    ...
    const signIn = async (email, password)=>{
        try {
            ...
            if (data.user) {
                ...
                try {
                    const { data: pointsData, error: pointsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('award_daily_login_points', {
                ...
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$referralService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["referralService"].checkPendingReferrals(data.user.id);
                } catch (referralError) {
...
"[project]/src/data/achievements.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/services/achievementService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/supabaseService.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$achievements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/achievements.ts [app-ssr] (ecmascript)");
;
;
class AchievementService {
    ...
    static async getRecentLoginRecord(userId) {
        try {
            const now = new Date();
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getClient().from('daily_login_rewards').select('*').eq('user_id', userId).gte('created_at', new Date(now.getTime() - 24 * 60 * 60 * 1000).toISOString()).order('created_at', {
                ascending: false
            }).limit(1).maybeSingle();
            if (error) {
    ...
    static async awardDailyLoginPoints(userId) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(userId, totalPoints);
        // Record daily login
    ...
    static async recordDailyLogin(userId, points) {
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getClient().from('daily_login_rewards').insert({
                user_id: userId,
    ...
    static async updateLoginStreak(userId) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].updateStreak(userId, newStreak);
            return true;
        } catch (error) {
    ...
    static async checkDailyLoginAchievements(userId) {
        ...
        const dailyAchievements = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$achievements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["achievements"].filter((a)=>a.category === 'daily');
    ...
    static async unlockAchievement(userId, achievementId) {
        try {
            const achievement = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$achievements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAchievementById"])(achievementId);
            if (!achievement) return false;
            // Check if already unlocked
            const existing = await this.getUserAchievement(userId, achievementId);
            if (existing) return false;
            // Record achievement unlock
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getClient().from('user_achievements').insert({
                user_id: userId,
                achievement_id: achievementId,
                unlocked_at: new Date().toISOString(),
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(userId, achievement.points);
            return true;
        } catch (error) {
            console.error('Error unlocking achievement:', error);
            return false;
    ...
    static async getUserAchievements(userId) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getClient().from('user_achievements').select('*').eq('user_id', userId).order('unlocked_at', {
                ascending: false
            });
            if (error) {
    ...
    static async getUserAchievement(userId, achievementId) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getClient().from('user_achievements').select('*').eq('user_id', userId).eq('achievement_id', achievementId).single();
            if (error) {
    ...
    static async trackActivityAndCheckAchievements(userId, activityType, metadata) {
        ...
        try {
            ...
            // Award points
            if (pointsAwarded > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(userId, pointsAwarded);
            }
            return {
                pointsAwarded,
                newAchievements
    ...
    static async checkAndAwardAchievements(userId) {
        try {
            ...
            // Get user stats
            const userStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserStats(userId);
            if (!userStats) {
                return {
                    newAchievements,
                    pointsAwarded: 0
            ...
            const existingAchievements = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserAchievements(userId);
            const unlockedIds = new Set(existingAchievements.map((ua)=>ua.achievement_id));
            // Check all achievements
            for (const achievement of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$achievements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["achievements"]){
                ...
                if (shouldAward) {
                    ...
                    const awarded = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].unlockAchievement(userId, achievement.id);
                    if (awarded) {
                        newAchievements.push(achievement);
            ...
            if (totalPointsAwarded > 0) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(userId, totalPointsAwarded);
            }
            return {
                newAchievements,
    ...
    static async getAchievementStats(userId) {
        try {
            const allAchievements = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$achievements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["achievements"];
            const userAchievements = await this.getUserAchievements(userId);
            const unlockedIds = new Set(userAchievements.map((ua)=>ua.achievement_id));
            const categories = [
...
"[project]/src/contexts/UserDataContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const UserDataContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function useUserData() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(UserDataContext);
    if (context === undefined) {
...
function UserDataProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initializeUserData = async ()=>{
            ...
            try {
                ...
                let userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserProfile(authUser.id);
                if (!userProfile) {
                    // Create profile if it doesn't exist
                    userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].createUserProfile(authUser);
                    if (!userProfile) {
                        throw new Error('Failed to create user profile');
                    }
                }
                // Get user stats from Supabase
                const userStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserStats(authUser.id);
                if (!userStats) {
                    throw new Error('Failed to load user stats');
                }
                // Get user achievements from Supabase
                const userAchievements = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserAchievements(authUser.id);
                ...
                try {
                    const { newAchievements, pointsAwarded } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$achievementService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["achievementService"].checkAndAwardAchievements(authUser.id);
                    if (newAchievements.length > 0) {
                        console.log('New achievements unlocked:', newAchievements);
                        console.log('Points awarded:', pointsAwarded);
                        // Refresh user data to get updated achievements
                        const updatedUserAchievements = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserAchievements(authUser.id);
                        setUser((prev)=>prev ? {
                                ...prev,
                ...
                const profileChannel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].subscribeToUser(authUser.id, (profile)=>{
                    setUser((prev)=>prev ? {
                            ...prev,
                            ...profile
                        } : null);
                });
                const statsChannel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].subscribeToUserStats(authUser.id, (newStats)=>{
        ...
        initializeUserData();
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].unsubscribeAll();
        };
    }, [
        authUser
    ]);
    const updateUser = async (userData)=>{
        ...
        try {
            ...
            const updatedProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].updateUserProfile(authUser.id, profileUpdates);
            if (updatedProfile) {
                setUser((prev)=>prev ? {
                        ...prev,
                        ...userData
    ...
    const addPoints = async (points)=>{
        if (!authUser) return;
        try {
            const updatedProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].addPoints(authUser.id, points);
            if (updatedProfile) {
                setUser((prev)=>prev ? {
                        ...prev,
    ...
    const incrementStreak = async ()=>{
        ...
        try {
            ...
            const updatedProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].updateStreak(authUser.id, newStreak);
            if (updatedProfile) {
                setUser((prev)=>prev ? {
                        ...prev,
                        streak: newStreak
    ...
    const refreshData = async ()=>{
        if (authUser) {
            try {
                setLoading(true);
                const userProfile = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$supabaseService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseService"].getUserProfile(authUser.id);
                if (userProfile) {
                    setUser((prev)=>prev ? {
                            ...prev,
                            points: userProfile.points,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(UserDataContext.Provider, {
        value: value,
        children: children
    }, void 0, false, {
...
"[project]/src/components/layout/ResponsiveLayout.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function ResponsiveLayout({ children, className, maxWidth = '2xl', padding = 'md' }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('w-full mx-auto', getMaxWidthClass(), getPaddingClass(), className),
        children: children
    }, void 0, false, {
...
function ResponsiveGrid({ children, className, cols = {
    mobile: 1,
    tablet: 2,
    desktop: 3
}, gap = 'md' }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('grid', getColsClass(), getGapClass(), className),
        children: children
    }, void 0, false, {
        fileName: "[project]/src/components/layout/ResponsiveLayout.tsx",
        lineNumber: 89,
...
function MobileContainer({ children, className }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('min-h-screen bg-background', // Mobile safe areas
        'pb-safe-or-4', // Touch-friendly spacing
...
function ResponsiveText({ children, className, size = 'md', weight = 'normal', color = 'primary' }) {
    const getSizeClass = ()=>{
        switch(size){
            case 'xs':
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('leading-relaxed', getSizeClass(), getWeightClass(), getColorClass(), className),
        children: children
    }, void 0, false, {
        fileName: "[project]/src/components/layout/ResponsiveLayout.tsx",
        lineNumber: 172,
...
"[project]/src/components/theme/ThemeSwitcher.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ThemeSwitcher() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "fixed right-6 bottom-20 md:bottom-6 z-50 flex flex-col items-end gap-2",
        children: [
            isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "bg-white dark:bg-gray-800 rounded-lg shadow-xl p-3 mb-2 w-48",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                fileName: "[project]/src/components/theme/ThemeSwitcher.tsx",
                                lineNumber: 26,
                                columnNumber: 13
                            }, this),
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: themeOptions.map((option)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                variant: "outline",
                                size: "sm",
                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('justify-start gap-2 h-auto p-2', theme === option.id ? 'border-primary' : ''),
                                onClick: ()=>{
                                    setTheme(option.id);
                                    setIsOpen(false);
                                },
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('w-4 h-4 rounded-full', option.color)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/theme/ThemeSwitcher.tsx",
                                        lineNumber: 51,
                                        columnNumber: 17
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd294435._.js.map